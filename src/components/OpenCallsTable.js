...
return(
  <div > 
       <h1 className="page-header">Open Calls <button type="button" class="btn">
...
<button class="btn btn-warning">New (10)</button>
<button class="btn btn-success">Service Complete (45)</button>
        ...
        <tr>
          ...
          <th>    <div >  
             {/* <label for="inputServiceType">Status</label> */}
              <select id="inputServiceType" className="btn-transparent" >
                <option selected >Status</option>
                <option>Pending Initial</option>
  ...
  <path fill-rule="evenodd" d="M1 11.5a.5.5 0 0 0 .5.5h11.793l-3.147 3.146a.5.5 0 0 0 .708.708l4-4a.5.5 0 0 0 0-.708l-4-4a.5.5 0 0 0-.708.708L13.293 11H1.5a.5.5 0 0 0-.5.5zm14-7a.5.5 0 0 1-.5.5H2.707l3.147 3.146a.5.5 0 1 1-.708.708l-4-4a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 4H14.5a.5.5 0 0 1 .5.5z"></path>
                ...
                <span class="">Pending Return</span>
              </button></td>
          <td>ipsum</td>
          <td>dolor</td>
          <td>sit</td>
